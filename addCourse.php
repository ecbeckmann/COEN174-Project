...
if(isset($_POST['submit'])) {
                if(empty($_POST['university']) || empty($_POST['country']) || empty($_POST['city']) || empty($_POST['course_number']) || empty($_POST['course_name']) || empty($_POST['equivalent'])) 			{ 
			...
			if($row_cnt == 0) {                 		
				...
				//Insert data into table
                		$sql = "INSERT INTO courses (university, country, city, course_number, course_name, scu_equivalent) VALUES ('$university', '$country', '$city', '$course_number', '$course_name', '$equivalent')";
